...
class Node:
    ...
    def __init__(self, parent, feature: str, value: bool, data: list, info_gain: float = 0):
        ...
        self.value = value  # feature value of this ndoe
        ...
        while not queue.empty():
            ...
            for node in nodes:
                ...
                for f in features:
                    ...
                    """Add next possible ndoes into the queue"""
                    """Your code here"""
                    raise NotImplementedError()
...
if __name__ == '__main__':
    ...
    data = [
        dict(x=dict(author=True, thread_new=True, length_long=True, read_home=True), y=False),
        dict(x=dict(author=False, thread_new=True, length_long=False, read_home=False), y=True),
        dict(x=dict(author=False, thread_new=False, length_long=True, read_home=False), y=False),
        dict(x=dict(author=True, thread_new=False, length_long=True, read_home=True), y=False),
        dict(x=dict(author=True, thread_new=True, length_long=False, read_home=True), y=True),
        dict(x=dict(author=True, thread_new=False, length_long=True, read_home=False), y=False),
        dict(x=dict(author=False, thread_new=False, length_long=False, read_home=False), y=False),
        dict(x=dict(author=False, thread_new=True, length_long=False, read_home=False), y=True),
        dict(x=dict(author=True, thread_new=False, length_long=True, read_home=True), y=False),
        dict(x=dict(author=True, thread_new=True, length_long=True, read_home=False), y=False),
        dict(x=dict(author=False, thread_new=False, length_long=False, read_home=True), y=False),
        dict(x=dict(author=True, thread_new=True, length_long=True, read_home=False), y=False),
        dict(x=dict(author=True, thread_new=False, length_long=False, read_home=True), y=True),
        dict(x=dict(author=True, thread_new=True, length_long=False, read_home=False), y=True),
        dict(x=dict(author=True, thread_new=True, length_long=False, read_home=True), y=True),
        dict(x=dict(author=True, thread_new=False, length_long=False, read_home=False), y=True),
        dict(x=dict(author=True, thread_new=True, length_long=False, read_home=True), y=True),
        dict(x=dict(author=False, thread_new=True, length_long=False, read_home=False), y=True),
    ]

    query = [
        dict(x=dict(author=False, thread_new=True, length_long=True, read_home=False)),
        dict(x=dict(author=True, thread_new=True, length_long=False, read_home=True)),
        dict(x=dict(author=False, thread_new=False, length_long=False, read_home=False)),
        dict(x=dict(author=False, thread_new=False, length_long=True, read_home=True)),
        dict(x=dict(author=True, thread_new=False, length_long=False, read_home=True)),
    ]

    print('loading data')
    with open('sample/data/data.json', 'wt') as f:
        json.dump(data, f, indent=2),
    with open('sample/data/query.json', 'wt') as f:
